...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='team',
            constraint=models.UniqueConstraint(models.F('contest'), models.F('user1'), name='user1_unique_per_contest'),
        ),
        migrations.AddConstraint(
            model_name='team',
            constraint=models.UniqueConstraint(models.F('contest'), models.F('user2'), name='user2_unique_per_contest'),
        ),
    ]
